    ...
    return (
        <div className='w-full flex justify-between gap-4 mb-3'>
            <div className='flex gap-4'>
                <div className="h-12 rounded-full gb-gray-600 flex items-center justify-center">
            ...
            <div className="flex items-center">
                {can(user, 'manage_comments') && user.id === comment.user_id && <button onClick={deleteComment}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round"
